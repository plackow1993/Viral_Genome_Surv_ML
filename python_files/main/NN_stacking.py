...
test_data = pd.read_csv('stacked_99.csv')
...
for neuron in neurons:
    ...
    model.fit(stack_train_X, stack_train_Y_categorical, epochs=250, batch_size=200, validation_data = (stack_test_X, stack_test_Y_categorical), verbose = 1)
    
    
    model.save('../../saved_NNs_stacking/NN_model_stacked_accuracy')
